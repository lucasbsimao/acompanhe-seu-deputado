...
| Enrichment Scraper                | Post-ingest scraping of PDF URLs               | `SenatorsDocUrlRetrievalPipeline`              |
...
| `dados-abertos-senado (transparency)` | `https://www6g.senado.leg.br/transparencia`             | None (Scraping)     |
